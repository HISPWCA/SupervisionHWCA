                            ...
                            >
                                ...
                                <div style={{ marginTop: '20px' }}>
                                    <div style={{ marginTop: '5px' }}>
                                        <Radio
                                            ...
                                            value="VISUALIZATION"
                                            checked={formState?.selectedTypeVisualization === 'VISUALIZATION'}
                                        />
                                    </div>
                                    <div style={{ marginTop: '5px' }}>
                                        <Radio
                                            ...
                                            value="MAP"
                                            checked={formState?.selectedTypeVisualization === 'MAP'}
                                        />
                                    </div>
                                </div>
                                <div style={{ marginTop: '10px' }}>
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                ...
                                                onChange={value =>
                                                    setFormState({
                                                        ...formState,
                                                        selectedVisualization: visualizations?.find(v => v.id === value)
                                                    })
                                                }
                                    ...
                                    {formState?.selectedTypeVisualization === 'MAP' && (
                                        <div>
                                            <div style={{ marginBottom: '5px' }}>{translate('SelectMaps')}</div>
                                            <Select
                                                ...
                                                onChange={value =>
                                                    setFormState({
                                                        ...formState,
                                                        selectedVisualization: maps?.find(m => m.id === value)
                                                    })
                                                }
                                                value={formState?.selectedVisualization?.map(m => m.id)}
                                                allowClear
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div style={{ marginTop: '20px' }}>
                                        <Row gutter={[8, 8]}>
                                            ...
                                            <Col md={12} sm={24}>
                                                ...
                                                >
                                                    <Input
                                                        placeholder={translate('Element_Name')}
                                                        style={{ width: '80%' }}
                                                        ...
                                                        disabled={formState?.dxDHIS2Element ? false : true}
                                                    />
                                            ...
                                            <Col md={4} sm={24}>
                                                <Button small onClick={handleAddElement} primary>
                                                    + {translate('Ajouter')}
                                                </Button>
                                            </Col>
                                        </Row>
                                ...
                                {formState?.selectedVisualization && (
                                    <div style={{ marginTop: '10px' }}>
                                        <Button primary onClick={handleSaveVisualizationToDataStore}>
                                            +{translate('Ajouter')}
                                        </Button>
                                    </div>
                                )}
