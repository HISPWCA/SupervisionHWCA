      ...
      return (
            <>
                  <Card className="my-shadow my-scrollable" bodyStyle={{ padding: '10px' }} size="small">
                        ...
                        <div style={{ marginTop: '30px' }}>
                              <div style={{ marginBottom: '10px', fontWeight: 'bold' }}>
                                    {`${translate('Cross_Check_Stock_Configuration')} ${getLetter(
                                                ...
                                                >
                                                      <div>
                                                            <Select
                                                                  ...
                                                                  allowClear
                                                                  optionFilterProp="label"
                                                                  value={formState?.selectedStockIndicator?.id}
                                                                  onChange={value => {
                                                                        setFormState({
                                                                              ...formState,
                                                                              selectedStockIndicator:
                                                                                    dataStoreIndicators
                                                                                          ?.find(
                                                                                                d =>
                                                                                                      d.name ===
                                                ...
                                                >
                                                      <div>
                                                            <Input
                                                                  ...
                                                                  min={0}
                                                                  type="number"
                                                                  value={formState?.selectedStockSourceMargin}
                                                                  onChange={event => {
                                                                        setFormState({
                                                                              ...formState,
                                                                              selectedStockSourceMargin:
                                                                                    event.target.value
                                                                        });
                                                                  }}
                                                            />
