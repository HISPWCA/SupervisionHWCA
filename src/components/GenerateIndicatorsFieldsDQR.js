                            ...
                            <tr key={uuid()}>
                                ...
                                >
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        <div>
                                            <Select
                                                placeholder={`${translate('Indicateurs')} ${indexInd + 1}`}
                                                style={{
                                                    width: '307px'
                                                }}
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 1 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 1`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 2 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 2`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 3 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 3`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 4 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 4`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 5 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 5`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 6 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 6`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 7 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 7`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 8 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 8`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 9 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 9`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 10 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 10`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 11 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 11`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 12 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 12`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 13 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 13`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 14 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 14`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    {ind?.viewMonthlyValue && parseInt(ind?.viewMonthlyValue) >= 15 && (
                                        <div style={{ marginTop: '5px' }}>
                                            <div
                                                style={{
                                                    marginBottom: '5px'
                                            ...
                                            <div>
                                                <Select
                                                    placeholder={`${translate('DHIS2_monthly_value')} 15`}
                                                    style={{
                                                        width: '307px'
                                                    }}
                                                    options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        >
                                            <div>{`${translate('Indicator_Keys_Word')}  ${indexInd + 1}`}</div>
                                    ...
                                    {formState?.recoupements?.length > indexRec + 1 && (
                                        <>
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    {`${translate('Recoupement_Primary')} ${indexRec + 1}`}
                                                </div>
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Recoupement_Primary')} ${
                                                            indexRec + 1
                                                        }`}
                                                        style={{
                                                            width: '307px'
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    <div>
                                                        {`${translate('Primary_Datasource_Key_Words')}  ${
                                                            indexRec + 1
                                                        }`}
                                                    </div>
                                                </div>
                                                                ...
                                                                recoupements:
                                                                    formState?.recoupements?.map(i => {
                                                                        if (i.id === rec.id) {
                                                                            return {
                                                                                ...i,
                                                                                primaryDataSourceKeyWords: word || []
                                                                            };
                                                                        }
                                                                        return i;
                                                                    }) || []
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    {`${translate('Recoupement_Secondary')} ${indexRec + 1}`}
                                                </div>
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Recoupement_Secondary')} ${
                                                            indexRec + 1
                                                        }`}
                                                        style={{
                                                            width: '307px'
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    <div>
                                                        {`${translate('Secondary_Datasource_Key_Words')}  ${
                                                            indexRec + 1
                                                        }`}
                                                    </div>
                                                </div>
                                                                ...
                                                                recoupements:
                                                                    formState?.recoupements?.map(i => {
                                                                        if (i.id === rec.id) {
                                                                            return {
                                                                                ...i,
                                                                                secondaryDataSourceKeyWords: word || []
                                                                            };
                                                                        }
                                                                        return i;
                                                                    }) || []
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    <div>
                                                        {`${translate('Cross_Check_Keys_Word')}  ${indexRec + 1}`}
                                                    </div>
                                                </div>
                                                <div>
                                                    <TagsInput
                                    ...
                                    {formState?.recoupements?.length === indexRec + 1 && (
                                        <>
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                >
                                                    {`${translate('Indicateur')}  (${translate('Recoupements')} ${
                                                        indexRec + 1
                                                    } Stock )`}
                                                </div>
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Indicateur')}`}
                                                        style={{
                                                            width: '307px'
                                                        }}
                                                        options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Initial_Stock')}`}
                                                        style={{
                                                            width: '307px'
                                                        }}
                                                        options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Distributed_Stock')}`}
                                                        style={{
                                                            width: '307px'
                                                        }}
                                                        options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Received_Stock')}`}
                                                        style={{
                                                            width: '307px'
                                                        }}
                                                        options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                            ...
                                            <div style={{ marginTop: '5px' }}>
                                                ...
                                                <div>
                                                    <Select
                                                        placeholder={`${translate('Rested_Stock')}`}
                                                        style={{
                                                            width: '307px'
                                                        }}
                                                        options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                            ...
                            <tr key={uuid()}>
                                ...
                                >
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        <div>
                                            <Select
                                                placeholder={`${translate('ConsistencyOverTime')} `}
                                                style={{
                                                    width: '307px'
                                                }}
                                                options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        <div>
                                            <Select
                                                placeholder={`${translate('What_Is_The_Current_Period')} `}
                                                style={{
                                                    width: '307px'
                                                }}
                                                options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                    ...
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        >
                                            {`${translate(
                                                'What_Was_The_Value_Of_The_Indicator_For_The_Current_Period_One_Year_Ago'
                                            )}`}
                                        </div>
                                        <div>
                                            <Select
                                                ...
                                                allowClear
                                                optionFilterProp="label"
                                                value={item?.currentPeriodOneYearAgo?.id}
                                                onChange={value => {
                                                    setFormState({
                                                        ...formState,
                                                        consistencyOvertimes:
                                    ...
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        >
                                            {`${translate('Last_Period')}`}
                                        </div>
                                        <div>
                                            <Select
                                                placeholder={`${translate('Last_Period')} `}
                                                style={{
                                                    width: '307px'
                                                }}
                                                options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                            ...
                            >
                                ...
                                {formState?.completeness?.dataElements?.map((item, indexItem) => (
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        <div>
                                            <Select
                                                placeholder={`${translate('Data_Element')} ${indexItem + 1}`}
                                                style={{
                                                    width: '207px'
                                                }}
                                                options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                                ...
                                                onChange={value => {
                                                    setFormState({
                                                        ...
                                                        completeness: {
                                                            ...formState?.completeness,
                                                            dataElements: formState?.completeness?.dataElements?.map(
                                                                i => {
                                                                    if (i.id === item.id) {
                                                                        return {
                                                                            ...i,
                                        ...
                                        <div style={{ marginTop: '5px' }}>
                                            ...
                                            >
                                                <div>{`${translate('Keys_Word')} ${indexItem + 1}`}</div>
                                            </div>
                                            <div>
                                                <TagsInput
                                                    style={{ width: '100%' }}
                                                    ...
                                                    onChange={word => {
                                                        setFormState({
                                                            ...
                                                            completeness: {
                                                                ...formState?.completeness,
                                                                dataElements:
                                                                    formState?.completeness?.dataElements?.map(i => {
                                                                        if (i.id === item.id) {
                                                                            return {
                                                                                ...i,
                                                                                keyWords: word
                            ...
                            >
                                {formState?.completeness?.sourceDocuments?.map((item, indexItem) => (
                                    <div style={{ marginTop: '5px' }}>
                                        ...
                                        <div>
                                            <Select
                                                placeholder={`${translate('Source_Document')} ${indexItem + 1}`}
                                                style={{
                                                    width: '207px'
                                                }}
                                                options={formState?.selectedProgramStageForConfiguration?.programStageDataElements?.map(
                                                ...
                                                onChange={value => {
                                                    setFormState({
                                                        ...
                                                        completeness: {
                                                            ...formState?.completeness,
                                                            sourceDocuments:
                                                                formState?.completeness?.sourceDocuments?.map(i => {
                                                                    if (i.id === item.id) {
                                                                        return {
                                                                            ...i,
                                                                            value: formState?.selectedProgramStageForConfiguration?.programStageDataElements?.find(
