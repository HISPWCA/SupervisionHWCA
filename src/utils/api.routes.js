...
export const PROGRAMS_ROUTE = API_BASE_ROUTE.concat('/programs.json?paging=false&fields=id,name,displayName,programIndicators[id,displayName],programTrackedEntityAttributes[trackedEntityAttribute[id,displayName]]')
