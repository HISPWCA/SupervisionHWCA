...
export const PAGE_INDICATORS_MAPPING = 'PAGE_INDICATORS_MAPPING';
...
export const PAGE_CONFIG_VISUALIZATION = 'PAGE_CONFIG_VISUALIZATION';
export const PAGE_REGISTERS_MANAGEMENT = 'PAGE_REGISTERS_MANAGEMENT';
export const PAGE_CROSS_CHECK_MANAGAEMENT = 'PAGE_CROSS_CHECK_MANAGAEMENT';
export const PAGE_SOURCE_DOCUMENT_MANAGEMENT = 'PAGE_SOURCE_DOCUMENT_MANAGEMENT';
export const PAGE_DATA_ELEMENT_MANAGEMENT = 'PAGE_DATA_ELEMENT_MANAGEMENT';

export const MES_PLANIFICATIONS = 'MES_PLANIFICATIONS';
